...
class TapTheBlackScreen extends StatefulWidget {
  @override
  _TapTheBlackScreenState createState() => _TapTheBlackScreenState();
}

class _TapTheBlackScreenState extends State<TapTheBlackScreen> {
  int _blockNumber = 9;
  int _score = 0;
  int _highScore = 0;
  int _time = 3000;
  ...
  void _replayHandler() {
    Navigator.of(context).pushReplacementNamed("/taptheblack");
  }
